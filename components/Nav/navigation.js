...
export default function Navigation() {
    return (
        <div class="w-full mx-auto bg-black justify-center border-b border-white">
            <div
                class="flex w-full flex-col lg:flex-row lg:items-center lg:justify-between max-w-7xl mx-auto px-8 py-2 border-x"
                x-data="{ open: false }">
                ...
                <a class="group block flex-shrink-0">
                    <Link href="/">
                        ...
                        <div class="ml-3">
                            <p
                            class="uppercase italic font-medium text-white group-hover:text-gray-300">
                            Streamer
                            </p>
                        </div>
                        </div>
                ...
                <button class="focus:shadow-outline focus:outline-none md:hidden rounded-lg">
                    <svg
                    class="h-8 w-8"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                class="flex-grow flex-col hidden items-center lg:flex lg:flex-row lg:justify-start lg:mt-0 gap-3 lg:gap-6 lg:p-0 lg:px-0 md:pb-0 opacity-100 p-4 px-5">
                <a
                    class="text-white/60 text-sm duration-200 ease-in-out focus:outline-none focus:shadow-none focus:text-white/5 hover:text-white lg:py-4 md:my-0 py-2 transform transition lg:ml-auto"
                >
                    <Link href="/about">
                        About
                    </Link>
                ...
                <a
                    class="text-white/60 text-sm duration-200 ease-in-out focus:outline-none focus:shadow-none focus:text-white/5 hover:text-white lg:py-4 md:my-0 py-2 transform transition"
                >
                    <Link href="/contact">
                        Contact
                    </Link>
                ...
                <a
                    class="relative flex text-sm items-center text-white hover:text-white duration-200 gap-3"
                >
                    <Link href="https://lexingtonthemes.lemonsqueezy.com/checkout/buy/f50206e4-c120-45bd-aa1e-22681509cdd4">
                        <span>
                            Demo - Download for free &nbsp; &rarr;
                        </span>
                    </Link>
                </a>
                </nav>
